 ...
 */
public class ForestCabinPiece extends TemplateStructurePiece
{
	 ...
	 * @return 
	 */
	public ForestCabinPiece(TemplateManager templateManager, ResourceLocation templateResource, BlockPos pos, Rotation rotation)
	{
		super(VeFeature.FOREST_CABIN_PIECE, 0);
	 ...
	 */
	public ForestCabinPiece(TemplateManager templateManager, CompoundNBT nbt)
	{
		super(VeFeature.FOREST_CABIN_PIECE, nbt);
	...
	{
		if("forest_cabin_chest".equals(function))
		{
