...
public class VeWoodCuttingRecipe extends SingleItemRecipe
{
	public VeWoodCuttingRecipe(IRecipeType<?> type, IRecipeSerializer<?> serializer, ResourceLocation id, String group, Ingredient ingredient, ItemStack result)
	{
