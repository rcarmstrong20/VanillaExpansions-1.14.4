...
public class VeMultiPlushBlock extends VePlushBlock
{
	...
	protected static final VoxelShape THREE_MAGMA_CUBE_BODY_AABB = Block.makeCuboidShape(6.0D, 17.0D, 6.0D, 10.0D, 21.0D, 10.0D);
	protected static final VoxelShape THREE_MAGMA_CUBE_SOUTH_LEFT_EYE_AABB = Block.makeCuboidShape(6.5D, 19.0D, 10.0D, 7.5D, 20.0D, 10.5D);
	protected static final VoxelShape THREE_MAGMA_CUBE_SOUTH_RIGHT_EYE_AABB = Block.makeCuboidShape(8.5D, 19.0D, 10.0D, 9.5D, 20.0D, 10.5D);
	...
	protected static final VoxelShape ONE_TWO_AND_THREE_MAGMA_CUBE_SOUTH_AABB = VoxelShapes.or(ONE_AND_TWO_MAGMA_CUBE_SOUTH_AABB, THREE_MAGMA_CUBE_SOUTH_AABB);
	protected static final VoxelShape THREE_MAGMA_CUBE_NORTH_LEFT_EYE_AABB = Block.makeCuboidShape(6.5D, 19.0D, 6.0D, 7.5D, 20.0D, 5.5D);
	protected static final VoxelShape THREE_MAGMA_CUBE_NORTH_RIGHT_EYE_AABB = Block.makeCuboidShape(8.5D, 19.0D, 6.0D, 9.5D, 20.0D, 5.5D);
	...
	protected static final VoxelShape ONE_TWO_AND_THREE_MAGMA_CUBE_NORTH_AABB = VoxelShapes.or(ONE_AND_TWO_MAGMA_CUBE_NORTH_AABB, THREE_MAGMA_CUBE_NORTH_AABB);
	protected static final VoxelShape THREE_MAGMA_CUBE_WEST_LEFT_EYE_AABB = Block.makeCuboidShape(5.5D, 19.0D, 6.5D, 6.0D, 20.0D, 7.5D);
	protected static final VoxelShape THREE_MAGMA_CUBE_WEST_RIGHT_EYE_AABB = Block.makeCuboidShape(5.5D, 19.0D, 9.5D, 6.0D, 20.0D, 8.5D);
	...
	protected static final VoxelShape ONE_TWO_AND_THREE_MAGMA_CUBE_WEST_AABB = VoxelShapes.or(ONE_AND_TWO_MAGMA_CUBE_WEST_AABB, THREE_MAGMA_CUBE_WEST_AABB);
	protected static final VoxelShape THREE_MAGMA_CUBE_EAST_LEFT_EYE_AABB = Block.makeCuboidShape(10.5D, 19.0D, 6.5D, 10.0D, 20.0D, 7.5D);
	protected static final VoxelShape THREE_MAGMA_CUBE_EAST_RIGHT_EYE_AABB = Block.makeCuboidShape(10.5D, 19.0D, 9.5D, 10.0D, 20.0D, 8.5D);
	...
	protected static final VoxelShape ONE_TWO_AND_THREE_MAGMA_CUBE_EAST_AABB = VoxelShapes.or(ONE_AND_TWO_MAGMA_CUBE_EAST_AABB, THREE_MAGMA_CUBE_EAST_AABB);
	...
	public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context)
	{
		...
		{
			return VeMultiPlushBlock.defineShapes(state, ONE_MAGMA_CUBE_SOUTH_AABB, ONE_AND_TWO_MAGMA_CUBE_SOUTH_AABB, ONE_TWO_AND_THREE_MAGMA_CUBE_SOUTH_AABB, ONE_MAGMA_CUBE_NORTH_AABB, ONE_AND_TWO_MAGMA_CUBE_NORTH_AABB, ONE_TWO_AND_THREE_MAGMA_CUBE_NORTH_AABB, ONE_MAGMA_CUBE_WEST_AABB, ONE_AND_TWO_MAGMA_CUBE_WEST_AABB, ONE_TWO_AND_THREE_MAGMA_CUBE_WEST_AABB, ONE_MAGMA_CUBE_EAST_AABB, ONE_AND_TWO_MAGMA_CUBE_EAST_AABB, ONE_TWO_AND_THREE_MAGMA_CUBE_EAST_AABB);
		}
		return NORMAL_CUBE;
	}
