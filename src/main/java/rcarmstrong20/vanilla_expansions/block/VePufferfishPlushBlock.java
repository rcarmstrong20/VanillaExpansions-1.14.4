...
public class VePufferfishPlushBlock extends VePlushBlock
{
	...
	public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit)
	{
		...
		{
			worldIn.playSound(null, pos, SoundEvents.ENTITY_PUFFER_FISH_BLOW_UP, SoundCategory.BLOCKS, 1.0F, 0.8F + worldIn.rand.nextFloat() * 0.4F);
			worldIn.setBlockState(pos, state.with(PUFFED, Integer.valueOf(puffed_property + 1)), 3);
		}
		else
		{
			worldIn.playSound(null, pos, SoundEvents.ENTITY_PUFFER_FISH_BLOW_OUT, SoundCategory.BLOCKS, 1.0F, 0.8F + worldIn.rand.nextFloat() * 0.4F);
			worldIn.setBlockState(pos, state.with(PUFFED, 0), 3);
		}
		return true;
	}
	...
	{
		return VePufferfishPlushBlock.defineShapes(state, PUFFERFISH_0_NORTH_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_SOUTH_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_WEST_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_EAST_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE, PUFFERFISH_0_NORTH_BODY_SHAPE);
	}
