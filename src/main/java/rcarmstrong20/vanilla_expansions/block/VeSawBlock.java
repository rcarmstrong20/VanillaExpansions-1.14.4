...
public class VeSawBlock extends StonecutterBlock
{
	...
	public INamedContainerProvider getContainer(BlockState state, World worldIn, BlockPos pos) {
		...
		{
			return new VeSawContainer(p_220283_2_, p_220283_3_, IWorldPosCallable.of(worldIn, pos));
		}, name);
	}
}
