...
public class VePlushBlock extends HorizontalBlock implements IWaterLoggable
{
	...
	//protected static final VoxelShape ENDERMAN_SOUTH_SHAPE = VeCollisionUtil.rotate180(Axis.Y, WOLF_NORTH_SHAPE);
	//protected static final VoxelShape ENDERMAN_WEST_SHAPE = VeCollisionUtil.rotate270(Axis.Y, WOLF_NORTH_SHAPE);
	//protected static final VoxelShape ENDERMAN_EAST_SHAPE = VeCollisionUtil.rotate90(Axis.Y, WOLF_NORTH_SHAPE);
