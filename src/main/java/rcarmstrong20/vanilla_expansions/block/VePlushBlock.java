...
public class VePlushBlock extends HorizontalBlock implements IWaterLoggable
{
	...
	protected static final VoxelShape PIG_WEST_FRONT_LEFT_LEG_SHAPE = Block.makeCuboidShape(6.0D, 0.0D, 4.5D, 8.0D, 4.0D, 7.0D);
	protected static final VoxelShape PIG_WEST_BACK_RIGHT_LEG_SHAPE = Block.makeCuboidShape(13.5D, 0.0D, 9.0D, 15.5D, 4.0D, 11.5D);
	protected static final VoxelShape PIG_WEST_BACK_LEFT_LEG_SHAPE = Block.makeCuboidShape(13.5D, 0.0D, 4.5D, 15.5D, 4.0D, 7.0D);
	protected static final VoxelShape PIG_WEST_TAIL1_SHAPE = Block.makeCuboidShape(15.0D, 4.0D, 6.0D, 15.5D, 7.5D, 7.0D);
	protected static final VoxelShape PIG_WEST_TAIL2_SHAPE = Block.makeCuboidShape(15.0D, 4.0D, 7.0D, 15.5D, 5.0D, 10.0D);
	protected static final VoxelShape PIG_WEST_TAIL3_SHAPE = Block.makeCuboidShape(15.0D, 7.5D, 7.0D, 15.5D, 8.5D, 9.0D);
	protected static final VoxelShape PIG_WEST_TAIL4_SHAPE = Block.makeCuboidShape(15.0D, 6.5D, 9.0D, 15.5D, 7.5D, 10.0D);
	protected static final VoxelShape PIG_WEST_TAIL5_SHAPE = Block.makeCuboidShape(15.0D, 5.5D, 8.0D, 15.5D, 6.5D, 9.0D);
	protected static final VoxelShape PIG_WEST_RIGHT_EYE_SHAPE = Block.makeCuboidShape(0.5D, 7.5D, 8.5D, 1.0D, 8.5D, 10.0D);
	protected static final VoxelShape PIG_WEST_LEFT_EYE_SHAPE = Block.makeCuboidShape(0.5D, 7.5D, 6.0D, 1.0D, 8.5D, 7.5D);
	protected static final VoxelShape PIG_WEST_SNOUT_SHAPE = Block.makeCuboidShape(0.0D, 6.0D, 7.0D, 1.0D, 7.0D, 9.0D);
	protected static final VoxelShape PIG_WEST_TAIL_1_AND_2_SHAPE = VoxelShapes.or(PIG_WEST_TAIL1_SHAPE, PIG_WEST_TAIL2_SHAPE);
	protected static final VoxelShape PIG_WEST_TAIL_3_AND_4_SHAPE = VoxelShapes.or(PIG_WEST_TAIL3_SHAPE, PIG_WEST_TAIL4_SHAPE);
	protected static final VoxelShape PIG_WEST_TAIL_1_2_3_AND_4_SHAPE = VoxelShapes.or(PIG_WEST_TAIL_1_AND_2_SHAPE, PIG_WEST_TAIL_3_AND_4_SHAPE);
	protected static final VoxelShape PIG_WEST_TAIL_SHAPE = VoxelShapes.or(PIG_WEST_TAIL_1_2_3_AND_4_SHAPE, PIG_WEST_TAIL5_SHAPE);
	protected static final VoxelShape PIG_WEST_BODY_AND_HEAD_SHAPE = VoxelShapes.or(PIG_WEST_BODY_SHAPE, PIG_WEST_HEAD_SHAPE);
	protected static final VoxelShape PIG_WEST_FRONT_LEGS_SHAPE = VoxelShapes.or(PIG_WEST_FRONT_RIGHT_LEG_SHAPE, PIG_WEST_FRONT_LEFT_LEG_SHAPE);
	protected static final VoxelShape PIG_WEST_BACK_LEGS_SHAPE = VoxelShapes.or(PIG_WEST_BACK_RIGHT_LEG_SHAPE, PIG_WEST_BACK_LEFT_LEG_SHAPE);
	protected static final VoxelShape PIG_WEST_LEGS_SHAPE = VoxelShapes.or(PIG_WEST_FRONT_LEGS_SHAPE, PIG_WEST_BACK_LEGS_SHAPE);
	protected static final VoxelShape PIG_WEST_LEGS_AND_TAIL_SHAPE = VoxelShapes.or(PIG_WEST_LEGS_SHAPE, PIG_WEST_TAIL_SHAPE);
	protected static final VoxelShape PIG_WEST_EYES_SHAPE = VoxelShapes.or(PIG_WEST_RIGHT_EYE_SHAPE, PIG_WEST_LEFT_EYE_SHAPE);
