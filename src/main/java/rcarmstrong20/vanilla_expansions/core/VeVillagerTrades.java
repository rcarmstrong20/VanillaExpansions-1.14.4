...
{
	public static final Int2ObjectMap<ITrade[]> LUMBERJACK_TRADES = register(ImmutableMap.of(1, new VillagerTrades.ITrade[] {itemForEmeraldTrade(new ItemStack(Items.APPLE), 16, 2), itemForEmeraldTrade(new ItemStack(VeItems.spruce_cone), 10, 2)},
